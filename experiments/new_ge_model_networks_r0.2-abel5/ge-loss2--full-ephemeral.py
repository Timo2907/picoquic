...
def start_nodes(delay_router, loss_router, server, client, mqs):
 ...
 delay_router.cmd('tc qdisc add dev rh-eth1 root netem loss gemodel 0.001% 20% 90% 2% limit ' + str(mqs))
 #move-to-burstmode (p) of 0.001%, move-to-gapmode (r) of 20%, drop-in-burstmode (1-h) of 90% and drop-in-gapmode (1-k) of 2%
