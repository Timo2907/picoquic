...
def start_nodes(delay_router, loss_router, server, client, mqs):
 ...
 delay_router.cmd('tc qdisc add dev rh-eth1 root netem loss gemodel 1.628% 10% 100% 0% limit ' + str(mqs))
 #move-to-burstmode (p) of 1.628%, move-to-gapmode (r) of 10%, drop-in-burstmode (1-h) of 100% and drop-in-gapmode (1-k) of 0%
