...
def start_nodes(delay_router, loss_router, server, client, mqs):
 ...
 delay_router.cmd('tc qdisc add dev rh-eth1 root netem loss gemodel 2.195% 10% 100% 0% limit ' + str(mqs))
 #move-to-burstmode (p) of 2.195%, move-to-gapmode (r) of 10%, drop-in-burstmode (1-h) of 100% and drop-in-gapmode (1-k) of 0%
